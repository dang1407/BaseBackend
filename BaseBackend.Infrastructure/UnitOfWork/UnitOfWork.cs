    ...
    public sealed class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork()
        {
            var configuration = new ConfigurationBuilder()
                    .SetBasePath(AppDomain.CurrentDomain.BaseDirectory) // Thư mục chứa file appsettings.json
                    .AddJsonFile("appsettings.json", optional: false, reloadOnChange: true)
                    .Build();
            _connectionString = configuration.GetConnectionString("DefaultConnection") ?? throw new KeyNotFoundException("Không có cấu hình DefaultConnection");
        }
